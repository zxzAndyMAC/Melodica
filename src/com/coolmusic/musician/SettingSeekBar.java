...
public class SettingSeekBar extends SeekBar {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mPopupWindow.showAsDropDown(this, mPosition[0],
					mPosition[1] - 30);
			break;
	...
	protected synchronized void onDraw(Canvas canvas) {
		// TODO Auto-generated method stub
		int thumb_x = (this.getProgress()+200) * (this.getWidth() - mThumbWidth)
				/ this.getMax();
		...
		if (mPopupWindow != null) {	
			try {
				this.getLocationOnScreen(mPosition);
				mPopupWindow.update(thumb_x - mThumbWidth,
